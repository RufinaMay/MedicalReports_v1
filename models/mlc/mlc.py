...
class MultilabelClassification:
    ...
    def create_model(self):
        model = Sequential([
            ...
            # Dropout(0.25),
            TimeDistributed(Conv2D(filters=128, kernel_size=(3, 3), activation='tanh')),
            TimeDistributed(Conv2D(filters=128, kernel_size=(3, 3), activation='relu')),
            TimeDistributed(MaxPooling2D(pool_size=(2, 2))),
            # Dropout(0.25),
            TimeDistributed(Conv2D(filters=256, kernel_size=(3, 3), activation="tanh")),
            TimeDistributed(Conv2D(filters=256, kernel_size=(3, 3), activation="tanh")),
            TimeDistributed(Conv2D(filters=256, kernel_size=(1, 1), activation="relu")),
            TimeDistributed(MaxPooling2D(pool_size=(2, 2))),
            # Dropout(0.25),
            TimeDistributed(Conv2D(filters=512, kernel_size=(3, 3), activation="tanh")),
            TimeDistributed(Conv2D(filters=512, kernel_size=(3, 3), activation="tanh")),
            TimeDistributed(Conv2D(filters=512, kernel_size=(1, 1), activation="tanh")),
            TimeDistributed(MaxPooling2D(pool_size=(2, 2))),
            # Dropout(0.25),
